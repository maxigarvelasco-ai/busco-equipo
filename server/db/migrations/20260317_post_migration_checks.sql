...
where table_schema = 'public'
  and (
    (table_name = 'profiles' and column_name in ('profile_type', 'birth_date')) or
    (table_name = 'clubs' and column_name in ('id', 'creator_id', 'name', 'city', 'zone', 'description', 'created_at')) or
